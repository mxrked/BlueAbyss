  ...
  render() {
    return (
      <div id={styles.modals} className="modals">
        <this.createModal modalID="A1" modalSRC={CEPHALOPOD_A1} />
        <this.createModal modalID="A2" modalSRC={CEPHALOPOD_A2} />
        <this.createModal modalID="A3" modalSRC={CEPHALOPOD_A3} />
        <this.createModal modalID="A4" modalSRC={CEPHALOPOD_A4} />
      </div>
    );
  }
}
