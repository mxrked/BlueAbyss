...
import Top from "../../components/galleries/mammal/Top";
import Togglers from "../../components/galleries/mammal/Togglers";
import Modals from "../../components/galleries/mammal/Modals";
...
export default function Mammal() {
  ...
  return (
    <div>
      <Head>
        <title>Blue Abyss - Galleries | Mammal</title>
        ...
        <meta
          property="og:url"
          content="http://basicallyeasy.com/next-projects/blueabyss/galleries/mammal/"
        />
         */}
        ...
        <link
          rel="canonical"
          href="http://basicallyeasy.com/next-projects/blueabyss/galleries/mammal/"
        />
