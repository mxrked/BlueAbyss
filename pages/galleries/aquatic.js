...
import Top from "../../components/galleries/aquatic/Top";
import Togglers from "../../components/galleries/aquatic/Togglers";
import Modals from "../../components/galleries/aquatic/Modals";
...
export default function Aquatic() {
  ...
  return (
    <div>
      <Head>
        <title>Blue Abyss - Galleries | Aquatic</title>
        ...
        <meta
          property="og:url"
          content="http://basicallyeasy.com/next-projects/blueabyss/galleries/aquatic/"
        />
         */}
        ...
        <link
          rel="canonical"
          href="http://basicallyeasy.com/next-projects/blueabyss/galleries/aquatic/"
        />
