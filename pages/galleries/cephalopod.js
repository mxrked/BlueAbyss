...
import Top from "../../components/galleries/cephalopod/Top";
import Togglers from "../../components/galleries/cephalopod/Togglers";
import Modals from "../../components/galleries/cephalopod/Modals";

import styles from "../../styles/views/galleries/Galleries.module.css";

export default function Cephalopod() {
  useEffect(() => {}, []);

  return (
    <div>
      <Head>
        <title>Blue Abyss - Galleries | Cephalopod</title>
        ...
        <meta
          property="og:url"
          content="http://basicallyeasy.com/next-projects/blueabyss/galleries/cephalopod/"
        />
         */}
        ...
        <link
          rel="canonical"
          href="http://basicallyeasy.com/next-projects/blueabyss/galleries/cephalopod/"
        />
